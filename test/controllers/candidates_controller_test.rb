...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference("Candidate.count") do
      post candidates_url, params: { candidate: { iebc_id: @candidate.iebc_id, name: @candidate.name } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { iebc_id: @candidate.iebc_id, name: @candidate.name } }
